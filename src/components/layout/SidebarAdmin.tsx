...
export default function SidebarAdmin({ itemActivo: itemActivoProp, abierto, onCerrar }: SidebarAdminProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-14 left-0 w-[220px] h-[calc(100vh-56px)] bg-white border-r border-[#EBEBEB] flex flex-col pb-4 z-[175] overflow-y-auto overflow-x-hidden transition-transform duration-300 ease-in-out animate-fade-in ${abierto ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}
      >
