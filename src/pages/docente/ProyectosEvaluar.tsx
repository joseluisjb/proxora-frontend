      ...
      {!cargando && !error && proyectos.length > 0 && (
        <div className="flex gap-3 mb-5 animate-slide-up">
          ...
          <select
            ...
            onChange={(e) => setFiltroEvaluacion(e.target.value as '' | 'pendiente' | 'evaluado')}
          ...
          >
            <option value="">Pendientes y evaluados</option>
            <option value="pendiente">Solo pendientes</option>
            <option value="evaluado">Solo evaluados</option>
          </select>
          <select
            value={filtroEstado}
